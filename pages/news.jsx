...
const News = ({ handleSidebar }) => {
  ...
  return (
    <>
      <Head>
        <title>Crypto Dashboard | News</title>
      </Head>
      <div className="bg-gray-100 min-h-screen">
        ...
        <div className="p-4">
          <div className="w-full m-auto p-4 border rounded-lg bg-white overflow-y-auto">
            <div className="p-2 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-center justify-between cursor-pointer">
              {news ? (
                news?.map((news, id) => (
